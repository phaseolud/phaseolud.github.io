...
<div class="flex flex-col md:flex-row justify-between items-start content-start">
<img class="object-contain max-h-[384px]" src="/blogdata/machine-learning-reconstruction/example_pol.png" />
<img class="object-contain max-h-[384px]" src="/blogdata/machine-learning-reconstruction/example_camera_image.png" />
</div>
