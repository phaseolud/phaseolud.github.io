...
_This blogpost is the realization of my science communication product, a deliverable for the master Science and Technology of Nuclear fusion at the Eindhoven University of Technology. The goal of this blogpost is to introduce why we need divertor imaging and let the reader understand the geometry by using an [interactive example](#interactiveExample)._
...
<source src="/blogdata/machine-learning-reconstruction/draw_cam_img_incr.mp4" type="video/mp4" />
It appears that your browser doesn't support this video.
</video>
</div>
...
As we can see, the calculation of the camera image given the cross-section happens quickly. However, transforming the camera image back to a cross-section is difficult and pretty slow. The exact reason is outside the scope of this blogpost. However, if you are interested, the example below shows why this is the case for a much smaller problem.
